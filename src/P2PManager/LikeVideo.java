...
public class LikeVideo {
    ...
    public static String query(String UserName, String VideoName){
        ...
        String qu3 = "UPDATE VideoList SET VideoDislikes = VideoDislikes - 1 WHERE VideoName = '" + VideoName + "';";
        ...
        try{
            ...
            if(flag == 0){
                db.execAction(qu2);
                System.out.println("User like added to LikesDislikesList successfully\n");
